...
- This repository contains only externally visible static preview files.
- Do not mirror the private TravelJournal repository.
...
After the preview flow is stable, the daily TravelJournal cron may publish the latest approved static package here after generation, validation, and explicit publish-gate checks pass.
